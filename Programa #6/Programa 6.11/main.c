...
/* Casa de bolsa.
El programa, al recibir como datos los precios mensuales de las accioes de sus
...
/*REN es un arreglo unidimensional de tipo real que utilizara para almacenar
...
{
/* La funcion F1 se utiliza para calcular el rendimiento anula de los fondos de
inversion. El resultado se almacena el el arreglo unidimensional V. */
int I;
...
void F2(float A[][12], int C)
{
/*Esta funcion calcula el promedio anualizado de la acciones de los diferentes
fondos.*/
}
int I, J;
float SUM, PRO;
...
printf("\n\nMEJOR fondo: %d\tRenimiento: %6.2f", M+1, ME);
