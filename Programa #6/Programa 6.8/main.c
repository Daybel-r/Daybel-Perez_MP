...
void Transpuesta(int [][MAX], int [][MAX], int, int);   /* Prototipos de funciones. */
...
/* Eata funcion se utiliza para una matriz de tipo entero de F filas y C
columnas. */
{
int I, J;
for (I=0; I<F; I++)
...
/* Esta funcion se utiliza para escibir una matriz de tipo entero de F filas
y C columnas -en este caso la tranpuesta. */
{
int I, J;
for (I=0; I<F; I++)
       for (J=0; J<C; J++)
