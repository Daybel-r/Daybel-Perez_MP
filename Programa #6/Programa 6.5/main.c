...
for (I=0; I<N; I++)
     for (J=0; J<EXA; J++)
    {
        printf("Ingrese la calificacion %d ", J+1, I+1);
        scanf("%f", &A[I][J]);
...
for (J=0; J<EXA; J++)
      SUM += A[I][J];
PRO = SUM/ EXA;
printf("\nEl promedio de alumno %d es: %5.2f", I+1, PRO);

}
}

void Funcion2(floatA[][EXA], int T)
/* Esta funcion se utiliza tanto para obtener el promedio de cada exaen, asi
