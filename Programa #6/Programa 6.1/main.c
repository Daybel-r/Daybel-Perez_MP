...
/* La funcion Lectura se utiliza para leer un arreglo biodimensional. Obseva
...
void Imprie(int A[][TAM],int F)
La funcion Imprie se utiliza para escribir un arreglo bidimensional
