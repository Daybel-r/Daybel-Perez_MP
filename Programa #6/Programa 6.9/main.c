...
/* Esta funcion se utiliza tanto para calcular el modulo entero el indice del
arreglo unimensional y 3, como para llamar a la funciones
...
/* Esta funcion obtiene el resultado de una sumatorua.*/
{
int I;
float SUM = 0.0
for (I=0; I<N; I++)
...
/* Esta funcion utiliza para escribir un arreglo unidimensional de tipo
real de N elementos.*/
{
int I;
for ( I=0; I<N; I++)
