...
/* Decodifica
El programa decodifica una cadena de caracteres compuesta por numero y
letras. */

void interpreta(char *);            /*Prototipo de funcio. */
...
while(cad[i] != '\0')
{
    ...
    {                               es una letra. */
     ...
     k = cad[i - 1] - 48;
     /* En la variable entera k se almacena el ascii el numero -convertido
