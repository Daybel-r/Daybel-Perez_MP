...
/* La funcion inverso obtiene precisamente el inversio de la cadena. La solucion
presentada es simple, pero para comprenderla es necesario tener conocimientos
tanto de pilas comp de recursividad. Observa que mientras no se encuentre el
