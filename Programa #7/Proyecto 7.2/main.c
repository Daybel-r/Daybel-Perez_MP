...
p1 = getchar();
if (isdigit(p1))
    /* La funcion regresa 1 si p1 es un digito y 0 en caso contrario. */
...
p1 = getchar();
if (isalpha (p1))
/* La funcion isalpha regresa 1 si p1 es una letra y o en caso contrario. */
...
if (isalpha (p1))
   if (islower (p1))
   /* La funcion islower regresa 1 si p1 es una letra minuscula y en 0 en caso
    contrario.
...
if (isalpha(p1))
    if(isupper(p1))
        ...
        /* La funcion tolowe convierte de mayuscula a minuscula. si la
