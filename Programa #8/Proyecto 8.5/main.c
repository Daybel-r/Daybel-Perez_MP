...
typedef             /* Declaracion de una estructura utilizando typedef. */
{
    int matricula;
    char nombre[20];
    char carrera[20];
...
void main(void)
{
alumno a1 = {120, "Maria", "Contabiliada", 8.9, "5 - 158 - 40 - 50"}, a2, a3;
/*Observa que solo el primer componente de una union puede recirbir valores por
medio de este tipo de asignaciones. */

/* Para que pueda observar las diferentes formas en que los campos de las
...
directamente, los campos de a2 se leen en el programa principal, u los campos
...
/*Observa que en la variable a2 de tipo estructura alumno el segund campo de la
...
/* Observa que si tratamos que imprimir el campo correo, escribe basura. */
...
/*Ahora escribe basura en el camp del telefono celular.*/
...
printf("Ingrese el telefono celular al alumno 2: ");
fflush(stdin);
