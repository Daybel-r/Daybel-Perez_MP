...
/* Estructuras -3.
El programa muestra la manera en que se declara una estructura aniada, asi
como la forma de acceso a los campos de las variables o apuntadores de tipo
estructuraas, tanto para lectura como para escritura. Se utiliza ademas una
...
struct empleado             /* Declaracion de la estructura anidada empleados. */
...
empelado. */
{
printf("\nIngrese el nombre del empelado: ");
gets(a->nombre);
fflush(stdin);
printf("\nIngrese el departamento de la empresa: ");
gets(a->departamento);
printf("\nIngrese el sueldp del empleado: ");
scanf("%f", &a->sueldo);
fflush(stdin);
printf("-- -Ingrese la direcion del empleado-- -");
printf("\n\tCalle: ");
gets(a->direccion.calle);
printf("\tNumero: ")
scanf("%d", &a->dirreccion.numero);
printf("\tCodigo Postal: ");
scanf("%d", &a->direccion.cp);
fflush(stdin);
printf("\tLocalidad: ")
gets(a->direccion.localiad);
}
...
/* En el programa principal se leen los campos de una variables, e3, y un
...
printf("Ingrese el sueldo del empleado: ");
scanf("%f", &e3.sueldo);
printf("---Ingese la direccion del empleado--- -");
printf("\n\tCalle: ");
fflush(stdin);
...
printf("%s\t%s\t%.2f\t%s\t%d\t%d\t%s" e4.nombre, e4departamento, e4.sueldo,
