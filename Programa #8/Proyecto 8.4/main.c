...
typedef struct                  /*Declaracion de la estructura alumno utilizando un
                                typedef. */
{
int matricula;
char nombre[30];
...
do
{
printf("Ingrese le tamaño del arreglo: ");
scanf("%d", &TAM);
}
...
/* La function Lectura se utiliza para leer un arreglo unidimensional de tipo
