...
/* Esta function sirve para leer los datos de los alumno utilizando una
...
señala el numero de variables que se leeran o almacenaran en el disitivo
de almacenamiento secuandario, y el ultimo representa el apuntador al inicio de
la estructura FILE. */

printf("\n¿Desea ingresar informacion sobre mas alummno? (Si-1 No-0): ");
scanf("%d", &r);
}
}
