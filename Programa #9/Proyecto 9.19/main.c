...
nuevo archivo, un archivo de acceso directo compuesto por escritura y
...
en funcion de su matricula, y genera un nuevo archio. */
{
alumno alu;
int t, n, i;
t = sizeof(alumno);
...
a su vez, se utilizara para posicionarnos en el archivos. */
rewind(ap1);
