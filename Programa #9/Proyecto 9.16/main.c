...
/* Suma reales.
El programa lee cadena de caracteres de un archivo, detecta aquellas que
comienza con numeros, los suma y calcula el promedio de los mismo. */
...
que comienzan con numeros y obtienen la suma y el promedio de dichos
numeros. */
{
char cad[30];
int i = 0;
