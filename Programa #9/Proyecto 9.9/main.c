...
void lee(FILE *ap)
/* Esta funcion se utiliza para leer bloques de un archivos de acceso directo. */
{
alumno alu;

fread(&alu, sizeof(alumno), 1, ap);
/*Observa que la funcion fread tiene los mismos argumentos de la funcion
fwrite del programa anterior. Tambien es importante tomar nota de que cuando
tenemos que leer los registros de un archivos utilizando una estructura
...
intrucciones fwrite y fread es moverse y leer o escribir, segun sea el caso.
