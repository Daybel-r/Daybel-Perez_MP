...
ordenados en forma ascendentes considerando la matricula los alumnos. */
...
while (((!feof(ar)) ||n !b) && ((!feof(ar1)) || !b1))
{
  ...
  if (b1)  /* Si la bandera b1 esta encendida, se lee el archivo ar
